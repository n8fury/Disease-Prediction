...
root.title("CSE299 project Disease Prediction From Symptoms")
...
w2 = Label(root, justify='right', text="Detect your Diseases", background="light blue")
w2.config(font=("times new roman", 30, "bold"), justify="center", foreground="black")
w2.place(relx=0.5, rely=0.1, anchor='center')

w2 = tkinter.Label(root, justify='center', background="light blue")
w2.grid(row=0, column=0, columnspan=2, padx=350, pady=80)

# labeling the symtomps

S1Lb = Label(root, text="Select Your Symptoms : 1")
S1Lb.config(font=("times new roman", 15, "bold"), background="light blue")
S1Lb.grid(row=7, column=1, pady=10, sticky=W)

S2Lb = Label(root, text="Select Your Symptoms : 2")
S2Lb.config(font=("times new roman", 15, "bold"), background="light blue")
S2Lb.grid(row=8, column=1, pady=10, sticky=W)

S3Lb = Label(root, text="Select Your Symptoms : 3")
S3Lb.config(font=("times new roman", 15, "bold"), background="light blue")
S3Lb.grid(row=9, column=1, pady=10, sticky=W)

S4Lb = Label(root, text="Select Your Symptoms : 4")
S4Lb.config(font=("times new roman", 15, "bold"), background="light blue")
S4Lb.grid(row=10, column=1, pady=10, sticky=W)

S5Lb = Label(root, text="Select Your Symptoms : 5")
S5Lb.config(font=("times new roman", 15, "bold"), background="light blue")
S5Lb.grid(row=11, column=1, pady=10, sticky=W)

# predict buttons

lr = Button(root, text="Predict The Disease", height=2, width=20, command=message)
lr.config(font=("times new roman", 15), background="#273f6b", foreground="white")
